  ...
  return (
    <KeyboardAvoidingView style={Style.mainContainer} behavior={Platform.OS === 'ios' ? 'padding' : null}>
      ...
      <View style={[Style.primaryNav, { flexDirection: isRtl ? 'row-reverse' : 'row' }]}>
        ...
        <Text style={Fonts.White16Bold}>{tr('edit')}</Text>
      </View>
      <ScrollView nestedScrollEnabled={true} style={{ width: '100%' }}>
        <View style={[Style.contentContainer, { flexDirection: isRtl ? 'row-reverse' : 'row' }]}>
          ...
          >
            <Text style={Fonts.Black14Medium}>{tr('firstName')}</Text>
            <TextInput
          ...
          >
            <Text style={Fonts.Black14Medium}>{tr('lastName')}</Text>
            <TextInput
              style={Style.inputStyle}
          ...
          >
            <Text style={[Fonts.Black14Medium]}>{tr('phoneNumber')}</Text>
            <TextInput
              style={[Style.inputStyle]}
          ...
          >
            <Text style={Fonts.Black14Medium}>{tr('emailAddress')}</Text>
            <TextInput
              style={Style.inputStyle}
        ...
        <View style={[Style.contentContainer, { flexDirection: isRtl ? 'row-reverse' : 'row' }]}>
          ...
          >
            <Text style={Fonts.Black14Medium}>{tr('specialty')}</Text>
            <TextInput
              style={Style.inputStyle}
          ...
          >
            <Text style={Fonts.Black14Medium}>{tr('experience')}</Text>
            <TextInput
              style={Style.inputStyle}
          ...
          >
            <Text style={Fonts.Black14Medium}>{tr('color')}</Text>
            <TouchableOpacity
        ...
        >
          ...
          >
            <Text style={Fonts.Black14Medium}>{tr('hours')}</Text>
        ...
        <View style={[Style.contentContainer, { flexDirection: isRtl ? 'row-reverse' : 'row' }]}>
          ...
          >
            <Text style={Fonts.Black14Medium}>{tr('profileImage')}</Text>
            <TouchableOpacity
              onPress={() => {
